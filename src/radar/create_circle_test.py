...
draw.circle((img_width*y_ratio, img_width*x_ratio), radius, fill=key, width=0)
#draw.rectangle((30, 40, 60, 60), fill=50, width=0)
pixel_value_to_eps = {50: 30, 30: 11.68, 255: -1}

vec = np.array([0.2, 0.8]) - np.array([x_ratio, y_ratio])
...
outfile_name = "data/material_circle_pec.json"
